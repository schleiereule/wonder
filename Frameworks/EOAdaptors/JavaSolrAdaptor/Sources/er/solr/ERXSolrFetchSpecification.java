...
public class ERXSolrFetchSpecification<T extends EOEnterpriseObject> extends ERXFetchSpecification implements SolrFacet.Delegate {
     ...
     * 
     * @param resetBatchNumber
     *            Whether to reset the current batch number or not.
     */
    ...
    /**
     * @param statisticsAttributes
     *            the statisticsAttributes to set. Will result in new fetch.
     */
    ...
    /**
     * @param facet
     *            the facet to add. Will result in a new fetch.
     */
    ...
    /**
     * @param facet
     *            the facet to remove. Will result in a new fetch.
     */
    ...
    /**
     * @param qualifier
     *            the qualifier to set. Will result in a new fetch.
     */
    ...
    /**
     * @param entityName
     *            the entityName to set. Will result in a new fetch. Cannot be
     *            null.
     */
     ...
     * 
     * @param maxTime
     *            the maxTime to set in milliseconds.
     */
    ...
    /**
     * The minimum number of facet items a facet must have to be included in the
     * results. Will result in new fetch.
     * 
     * @param minFacetSize
     *            the minFacetSize to set
     */
    ...
    /**
     * The maximum number of facet items included in the results. Will result in
     * new fetch.
     * 
     * @param facetLimit
	...
	private void _processResponse() {
	    ...
	    // Facet fields
	    List<FacetField> facetFieldList = _queryResponse.getFacetFields();
		...
		if (facetFieldList.size() > 0) {
			...
			for (Count count : facetField.getValues()) {
			    ...
			    // Solr's API returns these things as simple
			    // strings, so
			    // need to convert to the correct value type.
			...
			// Can't fully rely on Solr sorting facet items
			// (currently
			// only deals with count and alpha.) So do our own
			// sorting
			// here.
